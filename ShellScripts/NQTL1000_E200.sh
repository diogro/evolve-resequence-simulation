...
mkdir -p NQTL1000f_E200 # Change this to what you want to name this particular quantitative trait architectures and/or the experimental design that you are simulating.
cd NQTL1000f_E200 # Same as above
...
do
    ...
    do
        ...
        do
            ...
            -d PopSize=5000 \
            -d SelectedSize=4500 \
            -d "OutPath='/home/diogro/projects/HS_simulations/data/epistatic_tests/NQTL1000f_E200/'" \
